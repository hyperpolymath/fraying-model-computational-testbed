...
Replace all {{PLACEHOLDER}} values:
  fraying-model-computational-testbed     - Your project name
  hyperpolymath            - GitHub/GitLab username or org
  fraying-model-computational-testbed             - Repository name
...
We as members, contributors, and leaders pledge to make participation in fraying-model-computational-testbed a harassment-free experience for everyone, regardless of age, body size, visible or invisible disability, ethnicity, sex characteristics, gender identity and expression, level of experience, education, socio-economic status, nationality, personal appearance, race, caste, colour, religion, or sexual identity and orientation.
...
- Open a [Discussion](https://github.com/hyperpolymath/fraying-model-computational-testbed/discussions) (for general questions)
