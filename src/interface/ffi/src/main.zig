...
// FRAYING_MODEL_COMPUTATIONAL_TESTBED FFI Implementation
//
...
const VERSION = "0.1.0";
const BUILD_INFO = "FRAYING_MODEL_COMPUTATIONAL_TESTBED built with Zig " ++ @import("builtin").zig_version_string;
